...
summary: Pure FlashBlade Storageデータコレクタの設定 
---
...
[role="lead"]
Data Infrastructure Insightsは、Pure StorageFlashBladeデータコレクタを使用して、REST APIのバージョン2を公開するFlashBladeクラスタからインベントリデータとパフォーマンスデータを収集します。
